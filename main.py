...
import argparse
import numpy as np
from modules.tokenizers import Tokenizer, LlamaTokenizer
...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='', help='the path to the directory containing the encoded wsi patches.')
    parser.add_argument('--ann_path', type=str, default='/mnt/e/challenge/reg/Wsi-Caption/REG', help='the path to the directory containing the data.')
    parser.add_argument('--split_path', type=str, default='/mnt/e/challenge/reg/Wsi-Caption/ocr/dataset_csv/reg_split.csv', help='the path to the directory containing the train/val/test splits.')
    ...
    # debug
    parser.add_argument("--checkpoint_dir", type=str, default='/mnt/e/challenge/reg/Wsi-Caption/results/')
